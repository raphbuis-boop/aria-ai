...
export function ListingInquiryForm({
    ...
    <>
      ...
      {step === "choose" ? (
        <>
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            ...
            <button
              ...
              className="flex-1 rounded-[10px] border border-border bg-secondary px-4 py-3 text-[13px] font-semibold text-foreground"
            >
              Schedule Showing
            </button>
          </div>
        ...
        <>
          ...
          <p className={`text-[13px] text-foreground ${modal ? "" : "mt-2"}`}>
            {intent === "showing"
        ...
        <div className="relative z-10 w-full max-w-lg rounded-t-[24px] border-[0.5px] border-b-0 border-border bg-card px-5 pb-10 pt-4">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex h-8 w-8 items-center justify-center rounded-full bg-border text-muted-foreground"
              aria-label="Close"
            >
              <X size={14} />
            </button>
  ...
  return (
    <div
      id="listing-inquiry"
      className="mt-8 rounded-[12px] border border-border bg-card px-4 py-4"
    >
      {formContent}
    </div>
  );
